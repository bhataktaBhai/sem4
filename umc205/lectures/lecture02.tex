...
\begin{center}
    \begin{tikzpicture}[scale=0.9, transform shape]
        ...
        \path
            (0e) edge node[near start] {$0$} (1e)
            (0e) edge node[near start] {$1$} (1o)
            (1e) edge node[near start] {$0$} (2e)
            (1e) edge node[near start] {$1$} (2o)
            (1o) edge node[near start] {$0$} (2o)
            (1o) edge node[near start] {$1$} (2e)
            (2e) edge node[near start] {$0$} (3e)
            (2e) edge node[near start] {$1$} (3o)
            (2o) edge node[near start] {$0$} (3o)
            (2o) edge node[near start] {$1$} (3e)
            (3e) edge node[near start] {$1$} (0o)
            (3o) edge node[near start] {$0$} (0o)
            (0o) edge [loop right] node {$0, 1$} (0o)
            (3e) edge [bend right=2.5cm] node[above, near start] {$0$} (0e)
            (3o) edge [bend left=2.5cm] node[near start] {$1$} (0e);
    \end{tikzpicture}
\end{center}
