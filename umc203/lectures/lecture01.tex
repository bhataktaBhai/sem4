...
\subsection{Multivariate Gaussians} \label{sec:multivariate_gaussians}
\[
...
\begin{definition}[Positive definite] \label{def:multivariate_gaussians:positive_definite}
