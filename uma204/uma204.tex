...
% <lectures>
    ...
    \assignment{1}{Quiz 12 Jan 2024}{assignments/assignment01}
    \input{lectures/lecture04}
    \input{lectures/lecture05}
    \assignment{2}{Quiz 19 Jan 2024}{assignments/assignment02}
    ...
    \assignment{5}{Quiz 1 Mar 2024}{assignments/assignment05}
