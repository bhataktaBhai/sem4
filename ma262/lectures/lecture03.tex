...
\begin{proof}
    Applying Schur's lemma to $F_x$, we have the existence of an $n_x$ such
    that $nd_x$ can be written as a non-negative integer combination of
    elements of $F_x$, for all $n \ge n_x$.
    Let $nd_x = \sum_{i=1}^{k} a_i f_i$.
    Then by the Chapman-Kolmogorov equation, \begin{align*}
